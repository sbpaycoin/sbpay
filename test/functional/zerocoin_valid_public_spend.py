...
from fake_stake.base_test import SBPay_FakeStakeTest

class zSBPValidCoinSpendTest(SBPay_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zSBPs..." % DENOM_TO_USE)
