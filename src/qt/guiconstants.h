...
/* SBPay GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "SBPay"
#define QAPP_ORG_DOMAIN "sbpay.org"
#define QAPP_APP_NAME_DEFAULT "SBPay-Qt"
#define QAPP_APP_NAME_TESTNET "SBPay-Qt-testnet"
