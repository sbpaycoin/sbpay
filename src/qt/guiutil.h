...
/** Utility functions used by the SBPay Qt UI.
 */
namespace GUIUtil
{
...
// Render SBPay addresses in monospace font
...
// Parse "sbpay:" URI into recipient object, return true on successful parsing
