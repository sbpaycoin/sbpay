...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::SBP);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeSBPayAmount"))
        SoftSetArg("-anonymizesbpayamount", settings.value("nAnonymizeSBPayAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in sbpay.cpp during shotdown to also remove the window positions
