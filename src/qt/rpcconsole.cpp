                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzSBPPathCustom = GetArg("-zsbpbackuppath", "");
    ...
    if(!strzSBPPathCustom.empty()) {
        ui->wallet_customzsbpbackuppath->setText(QString::fromStdString(strzSBPPathCustom));
        ui->wallet_customzsbpbackuppath_label->setVisible(true);
        ui->wallet_customzsbpbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzSBPPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the SBPay RPC console.") + "<br>" +
