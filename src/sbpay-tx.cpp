...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SBPay Core sbpay-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  sbpay-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded sbpay transaction") + "\n" +
                               "  sbpay-tx [options] -create [commands]   " + _("Create hex-encoded sbpay transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded sbpay transaction
