...
#ifndef SBPay_ZSBPWALLET_H
#define SBPay_ZSBPWALLET_H
...
public:
    CzSBPWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZSBP(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZSBP(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
