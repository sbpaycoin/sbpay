...
extern UniValue DoZsbpSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzsbpseed(const UniValue& params, bool fHelp);
extern UniValue getzsbpseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzsbp(const UniValue& params, bool fHelp);
extern UniValue dzsbpstate(const UniValue& params, bool fHelp);
