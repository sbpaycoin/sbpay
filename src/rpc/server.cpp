...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SBPay features */
        {"sbpay", "listmasternodes", &listmasternodes, true, true, false},
        {"sbpay", "getmasternodecount", &getmasternodecount, true, true, false},
        {"sbpay", "masternodeconnect", &masternodeconnect, true, true, false},
        {"sbpay", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"sbpay", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"sbpay", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"sbpay", "masternodecurrent", &masternodecurrent, true, true, false},
        {"sbpay", "masternodedebug", &masternodedebug, true, true, false},
        {"sbpay", "startmasternode", &startmasternode, true, true, false},
        {"sbpay", "createmasternodekey", &createmasternodekey, true, true, false},
        {"sbpay", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"sbpay", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"sbpay", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"sbpay", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"sbpay", "getmasternodescores", &getmasternodescores, true, true, false},
        {"sbpay", "preparebudget", &preparebudget, true, true, false},
        {"sbpay", "submitbudget", &submitbudget, true, true, false},
        {"sbpay", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"sbpay", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"sbpay", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"sbpay", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"sbpay", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"sbpay", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"sbpay", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"sbpay", "checkbudgets", &checkbudgets, true, true, false},
        {"sbpay", "mnsync", &mnsync, true, true, false},
        {"sbpay", "spork", &spork, true, true, false},
        {"sbpay", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzsbpseed", &getzsbpseed, false, false, true},
        {"zerocoin", "setzsbpseed", &setzsbpseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzsbp", &searchdzsbp, false, false, true},
        {"zerocoin", "dzsbpstate", &dzsbpstate, false, false, true},
...
{
    return "> sbpay-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:20695/\n";
}
