Contributing to SBPay Core
============================

The SBPay Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/sbpay-project/sbpay/blob/master/doc/translation_process.md)
...
The following applies to code changes to the SBPay Core project, and is not to be
confused with overall SBPay Network Protocol consensus changes.

Whether a pull request is merged into SBPay Core rests with the project merge
...
Patches that change SBPay consensus rules are considerably more involved than
...
Where a patchset proposes to change the SBPay consensus, it must have been
...
The project leader is the release manager for each SBPay Core release.
