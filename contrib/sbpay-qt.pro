...
RESOURCES += src/qt/sbpay.qrc src/qt/sbpay_locale.qrc

TRANSLATIONS += src/qt/locale/sbpay_bg.ts \
                src/qt/locale/sbpay_de.ts \
                src/qt/locale/sbpay_en.ts \
                src/qt/locale/sbpay_es.ts \
                src/qt/locale/sbpay_fi.ts \
                src/qt/locale/sbpay_fr.ts \
                src/qt/locale/sbpay_it.ts \
                src/qt/locale/sbpay_ja.ts \
                src/qt/locale/sbpay_pl.ts \
                src/qt/locale/sbpay_pt.ts \
                src/qt/locale/sbpay_ru.ts \
                src/qt/locale/sbpay_sk.ts \
                src/qt/locale/sbpay_sv.ts \
                src/qt/locale/sbpay_vi.ts \
                src/qt/locale/sbpay_zh_CN.ts \
                src/qt/locale/sbpay_zh_TW.ts
